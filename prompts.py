...
summary_prompt = '''Шаблон для создания summary:
...
short_summary_prompt = '''Шаблон для создания summary:
Тема обсуждения: <text>
...
protocol_prompt = '''Проанализируй предоставленный текст совещания или статусной встречи и создай по нему структурированное саммари.
